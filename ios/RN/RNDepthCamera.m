...
- (void)updateWhiteBalance
{
    ...
    if (self.whiteBalance == RNCameraWhiteBalanceAuto) {
        ...
        AVCaptureWhiteBalanceTemperatureAndTintValues temperatureAndTint = {
            .temperature = [RNDepthCameraUtils temperatureForWhiteBalance:self.whiteBalance],
            .tint = 0,
        };
...
- (void)initializeCaptureSessionInput
{
    ...
    dispatch_async(self.sessionQueue, ^{
        ...
        AVCaptureVideoOrientation orientation = [RNDepthCameraUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
...
- (void)changePreviewOrientation:(UIInterfaceOrientation)orientation
{
    ...
    AVCaptureVideoOrientation videoOrientation = [RNDepthCameraUtils videoOrientationForInterfaceOrientation:orientation];
    dispatch_async(dispatch_get_main_queue(), ^{
