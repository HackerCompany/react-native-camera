...
@interface RCTDepthCamera ()

@property (nonatomic, weak) RCTDepthCameraManager *manager;
@property (nonatomic, weak) RCTBridge *bridge;

@end

@implementation RCTDepthCamera
{
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (allTouchesEnded && !_multipleTouches) {
        ...
        if (_defaultOnFocusComponent) {
            self.camFocus = [[RCTDepthCameraFocusSquare alloc]initWithFrame:CGRectMake(touchPoint.x-40, touchPoint.y-40, 80, 80)];
